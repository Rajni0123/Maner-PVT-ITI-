...
$router->post('/enquiry', fn() => PublicController::enquirySubmit());
...
$router->get('/admin/students/export', fn() => AdminStudentController::exportExcel());
$router->get('/admin/students/print', fn() => AdminStudentController::exportPdf());
$router->get('/admin/fees', fn() => AdminFeeController::index());
$router->get('/admin/fees/report', fn() => AdminFeeController::report());
$router->get('/admin/fees/report/export', fn() => AdminFeeController::reportExcel());
$router->get('/admin/fees/report/print', fn() => AdminFeeController::reportPdf());
