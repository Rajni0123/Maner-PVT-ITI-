        ...
        <section class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            <div class="space-y-2">
              <label class="block font-body-md font-bold text-primary uppercase text-xs tracking-widest">Password</label>
              <div class="relative">
                <input class="w-full bg-surface-container-low border border-outline-variant px-4 py-3 focus:border-primary-container focus:ring-0 font-body-md" name="admin_password" value="<?= e($_POST['admin_password'] ?? '') ?>" placeholder="Min 6 characters" required type="password" minlength="6"/>
                <button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-on-surface-variant" data-toggle-password>visibility</button>
              </div>
            </div>
            <div class="space-y-2">
              ...
              <div class="relative">
                <input class="w-full bg-surface-container-low border border-outline-variant px-4 py-3 focus:border-primary-container focus:ring-0 font-body-md" name="admin_password_confirm" value="<?= e($_POST['admin_password_confirm'] ?? '') ?>" placeholder="Confirm password" required type="password" minlength="6"/>
                <button type="button" class="absolute right-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-on-surface-variant" data-toggle-password>visibility</button>
              </div>
            </div>
          </div>
